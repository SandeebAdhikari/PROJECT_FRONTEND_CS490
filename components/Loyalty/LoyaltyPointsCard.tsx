...
import { getMyPoints, type LoyaltyPoints } from "@/libs/api/loyalty";

interface LoyaltyPointsCardProps {
  salonId: number | string;
  onPointsChange?: (points: LoyaltyPoints) => void;
}
  ...
  useEffect(() => {
    const fetchPoints = async () => {
      ...
      if (result.error) {
        ...
        setLoyaltyPoints(result.data);
        onPointsChange?.(result.data);
      }

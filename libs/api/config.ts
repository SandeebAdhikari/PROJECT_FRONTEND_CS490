...
export const API_ENDPOINTS = {
  ...
  PHOTOS: {
    ...
    LIST: (salonId: number | string) => `${API_BASE_URL}/api/photos/salon/${salonId}`,
    DELETE: (id: number | string) => `${API_BASE_URL}/api/photos/${id}`,
    ADD_SALON: `${API_BASE_URL}/api/photos/salon`,
    DELETE_SALON: (photoId: number | string) => `${API_BASE_URL}/api/photos/salon/${photoId}`,
  },
  HISTORY: {
  ...
  APPOINTMENTS: {
    ...
    GET_BY_ID: (id: number | string) => `${API_BASE_URL}/api/appointments/${id}`,
  },
  SALONS: {
    CREATE: `${API_BASE_URL}/api/salons`,
    LIST: `${API_BASE_URL}/api/salons`,
    GET_PUBLIC: (salonId: number | string) => `${API_BASE_URL}/api/salons/public/${salonId}`,
  ...
  USERS: {
    SALON_CUSTOMERS: (salonId?: number | string, search?: string) => {
      ...
      return `${API_BASE_URL}/api/users/salon-customers${params.toString() ? '?' + params.toString() : ''}`;
    },

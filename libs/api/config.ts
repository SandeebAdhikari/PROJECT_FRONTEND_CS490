...
export const API_ENDPOINTS = {
  ...
  NOTIFICATIONS: {
    ...
    LOYAL_CUSTOMERS: `${API_BASE_URL}/api/notifications/loyal-customers`,
    SEND_PROMOTION: `${API_BASE_URL}/api/notifications/send-promotion`,
  },
  PHOTOS: {
  ...
  SHOP: {
    ...
    REMOVE_FROM_CART: (itemId: number | string) => `${API_BASE_URL}/api/shop/cart/${itemId}`,
    DELETE_ALL_SERVICE_ITEMS: `${API_BASE_URL}/api/shop/cart-services`,
    UNIFIED_CART: `${API_BASE_URL}/api/shop/unified-cart`,
    ADD_APPOINTMENT_TO_CART: `${API_BASE_URL}/api/shop/add-appointment-to-cart`,
    CHECKOUT: `${API_BASE_URL}/api/shop/checkout`,
  },
  LOYALTY: {
    MY_SUMMARY: `${API_BASE_URL}/api/loyalty/my-summary`,
    MY_POINTS: (salonId: number | string) => `${API_BASE_URL}/api/loyalty/my-points/${salonId}`,
    ...
    GET_CONFIG: (salonId: number | string) => `${API_BASE_URL}/api/loyalty/config/${salonId}`,
  },
  PAYMENTS: {
    CHECKOUT: `${API_BASE_URL}/api/payments/checkout`,
    UNIFIED_CHECKOUT: `${API_BASE_URL}/api/payments/unified-checkout`,
    PAY_IN_STORE: `${API_BASE_URL}/api/payments/pay-in-store`,
